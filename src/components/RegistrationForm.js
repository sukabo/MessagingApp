        ...
        return (
            <View style={{backgroundColor: 'white', padding: 15, borderRadius: 10}} >
                ...
                <TextInput 
                    ...
                    placeholder='email'
                    onSubmitEditing={(event)=>{this.refs.registerName.focus()}}
                />
                <TextInput 
                    ref='registerName'
                    style={{height:40}}
                    ...
                    placeholder='name'
                    returnKeyType='next'
                    onSubmitEditing={(event)=>{this.refs.registerPassword.focus()}}
                />
                <TextInput 
                ...
                />                
                {
                    this.props.busy ? <ActivityIndicator /> : <Button onPress={this.onPressRegister.bind(this)} title='Register'/>
                }
            </View>
        );
    }
